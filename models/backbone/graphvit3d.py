...
class ViTGraph(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_features = self.encoder_dim = (
            encoder_dim  # num_features for consistency with other models
        )
        self.num_tokens = 1
        ...
        self.norm = (
            create_norm(norm_args, self.encoder_dim) or nn.Identity()
        )  # Norm layer is extremly important here!
    ...
    def forward(self, xyz, features=None):
        ...
        pos_embed = torch.cat(
            (self.cls_pos.expand(features.shape[0], -1, -1), pos_embed), dim=1
        )
