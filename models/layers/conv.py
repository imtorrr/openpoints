...
def create_convblock2d(
    *args, norm_args=None, act_args=None, order="conv-norm-act", **kwargs
):
    in_channels = args[0]
    out_channels = args[1]
...
class CreateResConvBlock2D(nn.Module):
    def __init__(
        self, mlps, norm_args=None, act_args=None, order="conv-norm-act", **kwargs
    ):
        super().__init__()
