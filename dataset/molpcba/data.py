...
class MOLPCBADataset(DatasetBase):
    def __init__(self, dataset_path, dataset_name="MOLPCBA", **kwargs):
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(
                name="ogbg-molpcba", root=self.dataset_path
            )
            return self._dataset
    ...
    def record_tokens(self):
        try:
            ...
            split = {"training": "train", "validation": "valid", "test": "test"}[
                self.split
            ]
